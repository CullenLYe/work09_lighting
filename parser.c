...
void parse_file ( char * filename,
  ...
  while ( fgets(line, sizeof(line), f) != NULL ) {
    ...
    if ( strncmp(line, "push", strlen(line)) == 13 ) {
      //printf("PUSH\b");
      push(csystems);
    }//end of push

    else if ( strncmp(line, "pop", strlen(line)) == 13 ) {
      //printf("PUSH\b");
      pop(csystems);
    }//end of push

    else if ( strncmp(line, "box", strlen(line)) == 13 ) {
    ...
    else if ( strncmp(line, "sphere", strlen(line)) == 13 ) {
      fgets(line, sizeof(line), f);
    ...
    else if ( strncmp(line, "torus", strlen(line)) == 13 ) {
      fgets(line, sizeof(line), f);
      //printf("torus\t%s", line);
    ...
    else if ( strncmp(line, "circle", strlen(line)) == 13 ) {
      fgets(line, sizeof(line), f);
    ...
    else if ( strncmp(line, "hermite", strlen(line)) == 13 ||
              strncmp(line, "bezier", strlen(line)) == 13 ) {
      if (strncmp(line, "hermite", strlen(line)) == 13 )
        type = HERMITE;
      else
        type = BEZIER;
      ...
      //printf("CURVE\t%s", line);
        ...
        else if ( strncmp(line, "line", strlen(line)) == 13 ) {
          fgets(line, sizeof(line), f);
          //printf("LINE\t%s", line);
        ...
        else if ( strncmp(line, "scale", strlen(line)) == 13 ) {
          fgets(line, sizeof(line), f);
          //printf("SCALE\t%s", line);
    ...
    else if ( strncmp(line, "move", strlen(line)) == 13 ) {
      fgets(line, sizeof(line), f);
      //printf("MOVE\t%s", line);
      sscanf(line, "%lf %lf %lf",
             xvals, yvals, zvals);
    ...
    else if ( strncmp(line, "rotate", strlen(line)) == 13 ) {
      fgets(line, sizeof(line), f);
    ...
    else if ( strncmp(line, "display", strlen(line)) == 13 ) {
      //printf("DISPLAY\t%s", line);
      //clear_screen(s);
      display( s );
    }//end display

    else if ( strncmp(line, "save", strlen(line)) == 13 ) {
      //printf("SAVE\t%s", line);
      fgets(line, sizeof(line), f);
      *strchr(line, '\n') = 0;
      //printf("name: %s\n", line);
